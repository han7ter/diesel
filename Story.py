...
class Story:
    ...
    chapters = {
        "Детство" : [
            Situation("2 года", "Вас впервые оставили одного в комнате. Окно было открыто, и с улицы был слышен гул проезжающих мимо дома машин и громкие голоса людей. В противоположном от окна углу был короб с вашими игрушками."),
